  ...
  Widget build(BuildContext context) {
    ...
    return GridView.builder(
      ...
      itemBuilder: (BuildContext context, int index) {
        return InkWell(
          onTap: () {
            if (pageName == AppRoutes.PLACE_A_ADD) {
              HomeController.to.categoryModel.value.categories!.edges![index]
                          .node!.keyword ==
                      "post_property_rent_ad"
                  ? Get.toNamed(AppRoutes.PROPERTY_INITAIL_PAGE)
                  : null;
            }
          },
          child: Card(
